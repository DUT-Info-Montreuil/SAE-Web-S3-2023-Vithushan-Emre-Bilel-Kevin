...
class VueGuide extends VueGenerique{
    ...
    public function affiche_guide_fichier () {
        ...
        <h1>Page guide</h1>
        <h3>Guide du jeu :</h3>
        <p>Voici un guide plus avancé vous permettant de découvrir le jeu avec des détails sur les différentes tours, les ennemis et le gameplay dans toute sa grandeur :</p>
        <a class="btn btn-primary" href="https://localhost/SaeDevWebS3/SpaceTowerDefense.pdf" download="SpaceTowerDefense_Guide.pdf"> Téléchargez le guide ici </a>
        <br><br>
    ...
    public function affiche_liste_tours() {
        ?>
        <h3>Les différents types de tours (elles sont séparées en 2 classes) :</h3>
        <br>
        <h4>Les tours normales :</h4>
        <p>Ce sont des tours possédants des attributs et des attaques basiques définie en fonction de leur capacitées</p><br>
        <div class="row divBootGenerale">
            <div class="col-2">
                <div class="list-group"  id="list-tab" role="tablist">
                    ...
                    <a class="list-group-item list-group-item-action" id="list-rapide-list" data-bs-toggle="list" href="#list-rapide" role="tab" aria-controls="list-rapide">Tour Rapides</a>
    ...
    public function affiche_liste_ennemis() {
        ?>
        <h3>Les différents types d'ennemis (ils sont aussi séparées en 2 classes):</h3>
        <br>
        <h4>Les aliens (Zentaris) :</h4>
        <p>Ce sont les ennemis de base, à la différence de nous les humains, ils peuvent vivre et se mouvoir sans problème dans l'espace sans equipement spécial, bien qu'ils n'ont pas l'air très puissant a première vue, certains d'entre eux sont de véritables monstre</p><br>
        <div class="row divBootGenerale">
            ...
            <div class="col-8">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active divDesc" id="list-alien" role="tabpanel" aria-labelledby="list-alien-list"><div class="dispflex"> <div class="div2">Image</div><div class="div3"><p>Les Soldats Zentari émergent comme des guerriers mystérieux d'une race jadis pacifique. Leur physiologie bioluminescente et leurs armures évoluées dénotent une adaptation étonnante, révélant une force mesurée malgré leur apparence redoutable. Agiles et tactiques, ces combattants extraterrestres privilégient la stratégie à la brutalité.</p></div></div></div>
                    <div class="tab-pane fade divDesc" id="list-general" role="tabpanel" aria-labelledby="list-general-list"><div class="dispflex"> <div class="div2">Image</div><div class="div3"><p>Les généraux Zentari, des êtres cosmiques d'une splendeur épique, se dressent comme les titans ultimes de la galaxie lointaine. Leurs silhouettes élancées, ornées d'armures incrustées de cristaux aux reflets iridescents, dégagent une aura de puissance transcendante. Chacun d'entre eux porte sur ses épaules la responsabilité colossale de diriger la race élitiste des Zentaris dans une quête implacable de conquête. Leurs yeux perçants, éclairés par une intelligence extraterrestre, sondent l'univers avec une détermination féroce.</p></div></div></div>
                </div>
            </div>
        </div>
        <h4>Les vaisseaux ennemis :</h4>
        <p>C'est la fierté Zentari et la plus puissante flotte aérienne de la galaxie. Leurs appareils disposent des meilleurs technologies et sont pilotées par des pilotes d'exeption</p><br>
        <div class="row divBootGenerale">
            <div class="col-2">
                <div class="list-group" id="list-tab2" role="tablist">
